...
screen 1 do
  top    [ :views, :separator, :title, :spacer, :keychain, :spacer, :tray, :sublets, :pacman, :battery, :separator, :separator, :clock ]
  bottom [ :spacer, :sublets, :gmail, :mpd, :volume ]
end
...
# Exec programs
grab "W-Return",  "urxvt"                                                                   #Terminal
grab "W-A-p",     "urxvt -e ncmpcpp"                                                        #Music Player
grab "W-A-w",     "firefox"                                                                 #Web
grab "W-A-m",     "firefox https://mail.google.com/mail/?hl=it#inbox"                       #Mail
grab "W-A-r",     "firefox http://www.google.com/reader/view/?hl=it&tab=mq"                 #Reader
grab "W-A-f",     "thunar"                                                                  #File Manager

#System Shortcuts
grab "W-A-c",     "urxvt -e vim ~/.config/subtle/subtle.rb"                                 #Settings
grab "W-A-d",     "dmenu_run"                                                               #Launch Programs
grab "C-A-l",     "slock"                                                                   #Lock Screen
grab "W-A-u",     "urxvt -hold -e packer -Syu"                                              #System Update
grab "C-A-Delete","urxvt -e htop"                                                           #System monitor

# Media keys
grab "XF86AudioMute", "amixer sset Master toggle"
grab "XF86AudioLowerVolume", "amixer set Master 3%- unmute"
grab "XF86AudioRaiseVolume", "amixer set Master 3%+ unmute"
